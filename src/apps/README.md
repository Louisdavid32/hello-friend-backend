...
| ----------- | ----------------------------------------------------------- | ------------------------------------- |
| `api`       | REST, sessions, tickets, admissions futures                 | PostgreSQL, Redis, signer futur       |
| `realtime`  | WSS applicatif, presence, chat futur                        | PostgreSQL, Redis                     |
| `worker`    | outbox, expiration audit tickets, Kafka/projections futures | PostgreSQL, Redis/Kafka selon handler |
